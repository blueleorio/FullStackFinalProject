    ...
    <Container>
      <Grid container direction="column" alignItems="center">
        ...
        <Grid item container spacing={2} justifyContent="space-around" style={{ marginTop: 40 }} >
          <Grid item xs={12} sm={6} md={8} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <Card sx={{ display: "flex", flexGrow: 1, justifyContent: "space-around", alignItems: "center", width: "100%", height: "100%" }}>
              ...
              <Grid item xs={4}>
                <Card sx={{ display: "flex", flexDirection: "column", alignItems: "flex-end", p: 3 }} raised={true}>
                  <Quote />
                </Card>
              </Grid>
            </Card>
